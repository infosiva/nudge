...
export const metadata: Metadata = {
  title: "Terms of Service | Tutiq",
  description: "Terms of service for Tutiq — your rights and responsibilities when using our service.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Acceptance of Terms">
        <p>
          By accessing or using Tutiq (https://tutiq.app), you agree to be bound by these Terms of Service.
          If you do not agree, please do not use the service.
        </p>
      </Section>

      <Section title="2. Description of Service">
        <p>AI personal tutor — personalised learning plans and practice for students of all levels.</p>
        <p className="mt-2">
      ...
      <Section title="5. Intellectual Property">
        <p>
          All original content, design and code on this service is owned by or licensed to Tutiq.
      ...
      <Section title="9. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, Tutiq shall not be liable for any indirect,
