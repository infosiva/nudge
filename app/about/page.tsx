...
export const metadata: Metadata = {
  title: "About | Tutiq",
  description: "About Tutiq — AI personal tutor — personalised learning plans and practice for students of all levels.",
...
export default function AboutPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">About Tutiq</h1>

      <section className="mb-8">
        <p className="text-base leading-7">AI personal tutor — personalised learning plans and practice for students of all levels.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-3">What We Offer</h2>
        <p>
          Tutiq is a free service built to make learning more accessible through the power of artificial intelligence.
      ...
      <section className="mb-8">
        ...
        <p>
          Tutiq is supported by advertising through Google AdSense. Ads help us keep the service
